...
public:
	...
	virtual_fn( get_view_angles( qangle_t& va ), 18, void( __thiscall* )( void*, qangle_t& ), va ); // 18

	// set current view orientation from va
	virtual_fn( set_view_angles( qangle_t& va ), 19, void( __thiscall* )( void*, qangle_t& ), va ); // 19
